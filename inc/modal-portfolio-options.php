...
function modal_portfolio_update() {
	// Réglages de base
	$modal_portfolio_filters		= $_POST['modal_portfolio_filters'];
	$modal_portfolio_text_modal		= $_POST['modal_portfolio_text_modal'];
	$modal_portfolio_title_modal	= $_POST['modal_portfolio_title_modal'];
	$modal_portfolio_title_thumbnail= $_POST['modal_portfolio_title_thumbnail'];
	$modal_portfolio_close_button	= $_POST['modal_portfolio_close_button'];
	
	// Réglages de effets jQuery
	$modalOpacity		= $_POST['modal_portfolio_modalOpacity'];
	$overlayCloseClick	= $_POST['modal_portfolio_overlayCloseClick'];
	$colorOverlay		= $_POST['modal_portfolio_colorOverlay'];
	$overlayDuration	= $_POST['modal_portfolio_overlayDuration'];
	$hideShowDuration	= $_POST['modal_portfolio_hideShowDuration'];
	$openEffect			= $_POST['modal_portfolio_openEffect'];
	$thumbnailsEffect	= $_POST['modal_portfolio_thumbnailsEffect'];
	$openUpEffect		= $_POST['modal_portfolio_openUpEffect'];
	$openDownEffect		= $_POST['modal_portfolio_openDownEffect'];
	$openUpDuration		= $_POST['modal_portfolio_openUpDuration'];
	$openDownDuration	= $_POST['modal_portfolio_openDownDuration'];
